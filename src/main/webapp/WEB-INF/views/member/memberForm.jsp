 	...
 	<div class="col-3 phone">
	  <input type="text" class="phone1" placeholder="핸드폰 번호">
	    ...
	    <div class="col-5 address">
	     <input type="text" class="form-control address1" name="ifmaZipcodeArray" id="ifmaZipcodeArray" placeholder="우편번호" readonly>
	    </div>
	 
	    <div class="col-7 address">
	     <button type="button" id="btnAddress" class="btnAddress btn-dark" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" >주소 검색</button>
	    </div>


		 <div class="col-12 address">	 
		  <input type="text" id="ifmaAddress1Array" class="form-control address2" placeholder="주소">
		  <input type="text" id="ifmaAddress2Array" class="form-control address2" placeholder="상세주소">
		 </div>
